...
export const esdiRsp = [
    '- Technical support for the companys employees.',
    '- Installation, maintenance and updating of computer hardware and software.',
    '- Management and resolution of computer incidents.'
]
